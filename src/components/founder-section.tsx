...
export default function FounderSection() {
  return (
    <section className="py-28 sm:py-40 bg-para-ivory-dark/40 text-para-charcoal relative overflow-hidden border-b border-para-charcoal/5">
      <div className="max-w-[1600px] mx-auto px-6 sm:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          {/* Left Column Portrait */}
          <div className="lg:col-span-5 relative" data-cursor="explore">
            <div className="relative w-full h-[500px] sm:h-[620px] overflow-hidden bg-para-charcoal border border-para-stone/30">
              <Image
          ...
          <div className="lg:col-span-7 flex flex-col space-y-8">
            ...
            <h2 className="font-serif text-section-title font-light text-para-charcoal leading-[1.02]">
              AR. URVAL DHRUVE <br />
              <span className="italic text-para-bronze font-normal">ON SPATIAL RESTRAINT.</span>
            </h2>

            <blockquote className="font-serif text-xl sm:text-2xl italic font-light text-para-charcoal/90 border-l-2 border-para-bronze pl-6 py-2 leading-relaxed">
            ...
            <div className="space-y-4 font-sans text-base text-para-charcoal/80 font-light leading-relaxed">
              <p>
            ...
            <div className="pt-4 grid grid-cols-2 sm:grid-cols-3 gap-6 border-t border-para-stone/20 font-sans text-xs tracking-widest text-para-bronze uppercase">
              <div>
                <span className="text-[10px] text-para-charcoal/50 block mb-1">PRACTICE</span>
                <span>ARCHITECTURE & INTERIORS</span>
              </div>
              <div>
                <span className="text-[10px] text-para-charcoal/50 block mb-1">LOCATION</span>
                <span>RAJKOT, GUJARAT</span>
              </div>
              <div>
                <span className="text-[10px] text-para-charcoal/50 block mb-1">SPECIALIZATION</span>
